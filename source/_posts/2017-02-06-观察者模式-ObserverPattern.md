...
![Observer](http://ocjtywvav.bkt.clouddn.com/DesignPatterns/ObserverPattern/Observer.png)

## 观察者模式的应用
结合上面的类图，我们现在将观察者模式应用到WeatherData项目中来。于是有了下面这张类图：
![ObserverForWeatherStation](http://ocjtywvav.bkt.clouddn.com/DesignPatterns/ObserverPattern/ObserverForWeatherStation.png)
