...
![filter(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/FilterOperator.png)
...
![take(int)](http://resources.baronzhang.com/rxjava/operator/filter/TakeOperator.png)
...
![takeLast(int)](http://resources.baronzhang.com/rxjava/operator/filter/TakeLastNOperator.png)
...
![takeUntil(Observable)](http://resources.baronzhang.com/rxjava/operator/filter/TakeUntilOperator.png)
...
![takeUntil(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/TakeUntilPOperator.png)
...
![skip(int)](http://resources.baronzhang.com/rxjava/operator/filter/SkipOperator.png)
...
![skipLast(int)](http://resources.baronzhang.com/rxjava/operator/filter/SkipLastOperator.png)

### ElementAt
**`elementAt(int)`**用来获取元素Observable发射的事件序列中的第n项数据，并当做唯一的数据发射出去。
![elementAt(int)](http://resources.baronzhang.com/rxjava/operator/filter/ElementAtOperator.png)
...
![debounce(long, TimeUnit)](http://resources.baronzhang.com/rxjava/operator/filter/DebounceOperator.png)
...
![debounce(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/DebounceFOperator.png)

### Distinct
**`distinct()`**的过滤规则是只允许还没有发射过的数据通过，所有重复的数据项都只会发射一次。
![distinct()](http://resources.baronzhang.com/rxjava/operator/filter/DistinctOperator.png)
...
![distinct(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/DistinctKeyOperator.png)
...
![distinctUntilChanged()](http://resources.baronzhang.com/rxjava/operator/filter/DistinctUntilChangedOperator.png)
...
![distinctUntilChanged(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/DistinctUntilChangedKeyOperator.png)
...
![first()](http://resources.baronzhang.com/rxjava/operator/filter/FirstOperator.png)
...
![first(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/FirstNOperator.png)
...
![last()](http://resources.baronzhang.com/rxjava/operator/filter/LastOperator.png)
...
![last(Func1)](http://resources.baronzhang.com/rxjava/operator/filter/LastPOperator.png)
