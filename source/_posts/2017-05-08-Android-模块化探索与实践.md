...
![](http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/header.jpg)
...
![Android 模块化设计方案](http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/modularization.png)
...
每个业务模块在 Android Studio 中的都是一个 Module ,因此在命名方面我们要求每个业务模块都以 Module 为后缀。如下图所示：<div align="left"><img src="http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/modules.png" width = "40%" alt="图片名称" align=center /></div>
...
如图：<div align="left"><img src="http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/manifest.png" width = "45%" alt="图片名称" align=center /></div>
...
但是这种代码写起来比较繁琐，且容易出错，出错也不太容易定位问题。因此一个简单易用、解放开发的路由框架是必须的了。<div align="left"><img src="http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/router2.png" width = "45%" alt="图片名称" align=center /></div>

我自己实现的路由框架分为<b>路由（Router）</b> 和<b>参数注入器（Injector）</b> 两部分：<div align="left"><img src="http://ocjtywvav.bkt.clouddn.com/blog/framework/android/2/router.png" width = "45%" alt="图片名称" align=center /></div>
